    ...
    modal.innerHTML = `
      ...
      <form id="form-pedido">
        <div class="form-grid">
          ...
          <div class="campo"><label>Data</label><input type="text" value="${g('data_abertura_recurso') ? Util.dataBr(g('data_abertura_recurso')) : 'Preencha na aba Recurso'}" disabled title="Data de Abertura do Recurso — vem da aba Recurso, não é editável aqui." /></div>
  ...
  async function render(container, _param, query = {}) {
    ...
    container.innerHTML = `
      ...
      <div class="toolbar" id="filtros">
        ...
        <label style="font-size:12px;color:var(--text-secondary);" title="Filtra pela Data de Abertura do Recurso">Data de <input type="date" name="data_inicio" value="${query.data_inicio || ''}" style="width:auto;" /></label>
